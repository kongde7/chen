...
<body >
	...
	<table border="0" class=ViewForm>
		<tr>
			...
			<td align="left"  ><h2>实时余额表-汇总</h2></td>
	...
	<jsp:include   page="pageList.jsp" >
        ...
        <jsp:param value="类型,计划额度,减:本月新增逾期,加:本月前增量逾期还款,实际可放款,审批中,对接中,已放款,合计,余额"  name="columns"/>
	...
	<%
		...
		String hjyed = Ebu2Util.floatAdd(ckyed, ldyed); //合计总额度
